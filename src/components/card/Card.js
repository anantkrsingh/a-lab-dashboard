export const Card = () => {
  return (
    <div className="shadow-lg rounded-2xl m-3 p-4 bg-white dark:bg-gray-700 h-[23em] ">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center">
          ...
          <button className="text-gray-200 pl-2">
            <svg
              width="25"
              height="25"
              fill="currentColor"
      ...
      <div className="flex  flex-wrap  justify-around items-center justify-start my-4 space-x-4">
      <div className="flex flex-col">
          <span className="px-2 py-1 mb-[10px] flex items-center text-xs rounded-md font-semibold text-green-500 bg-green-50">
           B Class
          </span>
        ...
        <div className="flex flex-col">
          <span className="px-2 mb-[10px] py-1 flex items-center text-xs rounded-md font-semibold text-green-500 bg-green-50">
            3 Credit
          </span>
          <span className="px-2 py-1 flex items-center text-xs rounded-md text-yellow-600 font-semibold bg-yellow-200">
           1 Hours/ Week
